...
class Meters:
    ...
    LLM_TIME_TO_FIRST_TOKEN = "gen_ai.client.time_to_first_token"
    LLM_TIME_PER_OUTPUT_TOKEN = "gen_ai.client.time_per_output_token"
    LLM_TIME_BETWEEN_TOKEN = "gen_ai.client.time_between_token"
